        ...
        <div className="flex flex-col items-center w-screen ">
            <div className="flex  flex-col justify-center -mt-30 ">
                ...
                <div className="flex flex-col w-150">
                    ...
                    <input  value={email} className=" bg-gray-300 text-center h-10 mp-1 mb-3 " onChange={(e) => setEmail(e.target.value)} />
                    ...
                    <input  type="password" value={password} className="bg-gray-300 text-center h-10  mb-3" onChange={(e) => setPassword(e.target.value)} />
                </div>
            </div>
