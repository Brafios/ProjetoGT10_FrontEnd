    ...
    return (
        <>
            <div className="flex flex-col md:flex-row w-full px-4">
                {/* Sidebar de pesquisa e cidades */}
                <aside className="md:sticky h-fit w-full md:w-[18%] mb-4 md:mb-1">
                ...
                {/* Conteúdo principal */}
                <main className="w-full md:w-[62%] md:px-4 md:ml-14 mb-4 md:mb-0">
                    {/* Carrossel */}
                    ...
                    <div className="p-4 mt-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 gap-y-8 mt-6">
